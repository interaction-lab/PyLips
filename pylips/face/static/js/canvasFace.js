...
function drawMouth(params, faceState, ctx) {
    ...
    upperLipPoints[2] += max_x_variation * (0.25 * faceState.AU10L - 0.25 * faceState.AU14L + 0.3 * faceState.AU18L - 0.25 * faceState.AU20L + 0.05 * faceState.AU23L) / 1.05;
    ...
    upperLipPoints[4] -= max_x_variation * (0.25 * faceState.AU10R - 0.25 * faceState.AU14R + 0.3 * faceState.AU18R - 0.25 * faceState.AU20R + 0.05 * faceState.AU23R) / 1.05;
    ...
    lowerLipPoints[2] += max_x_variation * (-0.25 * faceState.AU14L - 0.5 * faceState.AU16L - 0.2 * faceState.AU26L + 0.3 * faceState.AU18L - 0.25 * faceState.AU20L + 0.15 * faceState.AU23L) / 1.05;
